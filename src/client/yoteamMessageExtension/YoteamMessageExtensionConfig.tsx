...
/**
 * Implementation of the yoteam Message Extension configuration page
 */
export const YoteamMessageExtensionConfig = () => {
    ...
    return (
        <Provider theme={theme} styles={{ height: "100vh", width: "100vw", padding: "1em" }}>
            <Flex fill={true}>
                <Flex.Item>
                    <div>
                        <Header content="yoteam Message Extension configuration" />
                        <Checkbox
                            label="On or off?"
                            toggle
                            checked={onOrOff}
